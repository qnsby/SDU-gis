      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <Card>
            ...
            <CardContent>
              <div
                className="relative bg-green-50 rounded-lg overflow-hidden"
                style={{ height: '500px' }}
              >
                {/* SVG карта */}
                      ...
                      <rect
                        ...
                        fill={
                          selectedBuilding === building.id
                            ? '#3b82f6'
                            : buildingTypeColors[building.type as keyof typeof buildingTypeColors]
                        }
        ...
        <div className="space-y-6">
          ...
          {selectedBuildingData && (
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-gray-600">{selectedBuildingData.description}</p>

                <div className="flex items-center gap-2">
                  <Badge variant="secondary">{selectedBuildingData.floors} этажей</Badge>
                  <Badge
                    className={
                      buildingTypeColors[
                        selectedBuildingData.type as keyof typeof buildingTypeColors
                      ] + ' text-white'
                    }
                  >
                    {
                      buildingTypeLabels[
                        selectedBuildingData.type as keyof typeof buildingTypeLabels
                      ]
                    }
                  </Badge>
                </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Здания ({filteredBuildings.length})</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-2 max-h-64 overflow-y-auto">
                {filteredBuildings.map((building) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-600 line-clamp-2">{building.description}</p>
                  </div>
                ))}
              </div>
            </CardContent>
